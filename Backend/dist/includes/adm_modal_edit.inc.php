<?php
    ...
    echo            '</div>';
    echo        '</div>';
    echo        '<div class="form-group mt-4 mb-0"><button class="btn btn-block" name="edit-submit" value="'.$row['admin_id'].'" type="submit" style="background-color: #a8fdcc"><i class="far fa-edit" aria-hidden="true"></i></button></button></div>';
    echo    '</form>';